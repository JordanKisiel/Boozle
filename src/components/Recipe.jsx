...
export default function Recipe(props){
    ...
    return (
        <motion.div
            ...
            <img className="absolute w-28 aspect-square rounded-full border-4 border-pink-300 -top-[4rem]" src={props.recipe.strDrinkThumb ? props.recipe.strDrinkThumb : './src/assets/cocktail-image-placeholder.png'} alt={`thumbnail picture of ${props.recipe.strDrink} `} 
        />
